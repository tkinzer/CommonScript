...
exports.AssertionError = function(info) {
	Object.defineProperty(this, "message", {value: info.message, enumerable: true});
	Object.defineProperty(this, "actual", {value: info.actual, enumerable: true});
	Object.defineProperty(this, "expected", {value: info.expected, enumerable: true});
...
function factoryError(message, actual, expected) {
	return new exports.AssertionError({message: message, actual: actual, expected: expected});
}
			...
			if(actual instanceof Date && expected instanceof Date) {
				...
				for(var i = 0, l = key.actual.length; i < l && result; i++)
					if(key.actual[i] == key.expected[i])
						result = isDeepEqual(actual[key.actual[i]], expected[key.expected[i]]);
			}
